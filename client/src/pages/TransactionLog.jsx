...
function KindBadge({ kind }) {
  return (
    <span className={'tx-kind' + (kind === 'supply' ? ' tx-kind-supply' : ' tx-kind-return')}>
      {kind === 'supply' ? 'فاتورة توريد' : 'فاتورة مترجع'}
    </span>
  )
}
...
function GroupBlock({ title, subtitle, total, children, danger, muted }) {
  return (
        ...
        {summary && (
          <div className="tx-summary">
            ...
            <div className="tx-stat">
              ...
              <span className="tx-stat-value pos">{summary.supply_count} / {fmt(summary.supply_total)}</span>
            </div>
            <div className="tx-stat">
